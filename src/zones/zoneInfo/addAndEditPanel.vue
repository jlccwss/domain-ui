      ...
      <el-form ref="form" :model="editRow" size="small" :rules="rules">
         <el-form-item prop="rrName" label="记录名称">
           <el-row class="form-row">
             <el-col :span="14">
               <el-input v-model="editRow.rrName" :disabled="!!editRow.id"></el-input>
             </el-col>
        ...
        <el-form-item prop="rrType" label="记录类型">
            <el-select style="width:100%" :disabled="!!editRow.id" v-model="editRow.rrType">
