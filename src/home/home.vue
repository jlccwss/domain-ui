      ...
      <div class="content">
        <el-menu :unique-opened="true" :router="true" :default-openeds="openeds" class="menu" :default-active="currentNav">
          <el-submenu index="2" v-if="authority.includes('2')">
            ...
            <el-menu-item index="/home/zones">互联网</el-menu-item>
            <el-menu-item index="/home/gzones">广域网</el-menu-item>
            <el-menu-item index="/home/domainStatistics">域名统计</el-menu-item>
          </el-submenu>
          <el-submenu index="3" v-if="authority.includes('3')">
            <template slot="title">
              <span><span class="icon domain"></span>域名注册管理</span>
            </template>
            <el-menu-item index="/home/domains">域名管理</el-menu-item>
            <el-menu-item index="/home/registerDomain">域名注册</el-menu-item>
            <el-menu-item index="/home/sslCertificates">SSL证书</el-menu-item>
          </el-submenu>
          <el-submenu index="4" v-if="authority.includes('4')">
            ...
            <el-menu-item index="/home/records">备案管理</el-menu-item>
          ...
          <el-submenu index="5" v-if="authority.includes('5')">
            ...
            <el-menu-item index="/home/addressManage" @click="navToAddress">地址管理</el-menu-item>
          ...
          <el-submenu index="6" v-if="authority.includes('6')">
            ...
            <el-menu-item index="/home/users">账号管理</el-menu-item>
            <el-menu-item index="/home/auditlogs">操作日志</el-menu-item>
            <el-menu-item index="/home/contacts">联系人模板</el-menu-item>
            <el-menu-item index="/home/approveModule">审批模板</el-menu-item>
          </el-submenu>
          <el-submenu index="7" v-if="authority.includes('7')">
            <template slot="title">
              <span><span class="icon approal"></span>审批管理</span>
            </template>
            <el-menu-item index="/home/approveList">审批单管理</el-menu-item>
          </el-submenu>
          <el-submenu index="8" v-if="authority.includes('8')">
            <template slot="title">
              <span><span class="icon toogale"></span>灾备切换</span>
            </template>
            <el-menu-item index="/home/apps">应用管理</el-menu-item>
            <el-menu-item index="/home/groups">分组管理</el-menu-item>
          </el-submenu>
        </el-menu>
        <div class="page">
  ...
  methods: {
    ...
    getCurRole() {
      ...
      if (this.user.admin === 'admin') {
        this.authority = ['2', '3', '4', '5', '6', '7', '8'];//authority['admin'];
      } else {
        this.authority = this.user.roleid || [];
      }
    },
    handleCommand(type) {
      if (this[type]) {
